...
{
  quad_interfaces__msg__MotionServosParameters * msg = (quad_interfaces__msg__MotionServosParameters *)malloc(sizeof(quad_interfaces__msg__MotionServosParameters));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(quad_interfaces__msg__MotionServosParameters));
  bool success = quad_interfaces__msg__MotionServosParameters__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    quad_interfaces__msg__MotionServosParameters__fini(msg);
  }
  free(msg);
}
...
quad_interfaces__msg__MotionServosParameters__Sequence__init(quad_interfaces__msg__MotionServosParameters__Sequence * array, size_t size)
{
  ...
  quad_interfaces__msg__MotionServosParameters * data = NULL;
  if (size) {
    data = (quad_interfaces__msg__MotionServosParameters *)calloc(size, sizeof(quad_interfaces__msg__MotionServosParameters));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = quad_interfaces__msg__MotionServosParameters__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        quad_interfaces__msg__MotionServosParameters__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
quad_interfaces__msg__MotionServosParameters__Sequence__fini(quad_interfaces__msg__MotionServosParameters__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      quad_interfaces__msg__MotionServosParameters__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  quad_interfaces__msg__MotionServosParameters__Sequence * array = (quad_interfaces__msg__MotionServosParameters__Sequence *)malloc(sizeof(quad_interfaces__msg__MotionServosParameters__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = quad_interfaces__msg__MotionServosParameters__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    quad_interfaces__msg__MotionServosParameters__Sequence__fini(array);
  }
  free(array);
}
