...
class Metaclass_AuxServosCalibration(type):
    """Metaclass of message 'AuxServosCalibration'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'quad_interfaces.msg.AuxServosCalibration')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__aux_servos_calibration
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__aux_servos_calibration
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__aux_servos_calibration
            cls._TYPE_SUPPORT = module.type_support_msg__msg__aux_servos_calibration
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__aux_servos_calibration
...
class AuxServosCalibration(metaclass=Metaclass_AuxServosCalibration):
    """Message class 'AuxServosCalibration'."""
    ...
    _fields_and_field_types = {
        ...
        'min_angle': 'float[4]',
        'max_angle': 'float[4]',
        'calibration_angle_offset': 'float[4]',
        'ms_per_degree': 'float[4]',
    }
    ...
    def pin(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 4, \
                "The 'pin' numpy.ndarray() must have a size of 4"
            self._pin = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'pin' field must be a set or sequence with length 4 and each value of type 'int' and each integer in [-2147483648, 2147483647]"
    ...
    def min_angle(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 4, \
                "The 'min_angle' numpy.ndarray() must have a size of 4"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'min_angle' field must be a set or sequence with length 4 and each value of type 'float'"
    ...
    def max_angle(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 4, \
                "The 'max_angle' numpy.ndarray() must have a size of 4"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'max_angle' field must be a set or sequence with length 4 and each value of type 'float'"
    ...
    def calibration_angle_offset(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 4, \
                "The 'calibration_angle_offset' numpy.ndarray() must have a size of 4"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'calibration_angle_offset' field must be a set or sequence with length 4 and each value of type 'float'"
    ...
    def ms_per_degree(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 4, \
                "The 'ms_per_degree' numpy.ndarray() must have a size of 4"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'ms_per_degree' field must be a set or sequence with length 4 and each value of type 'float'"
