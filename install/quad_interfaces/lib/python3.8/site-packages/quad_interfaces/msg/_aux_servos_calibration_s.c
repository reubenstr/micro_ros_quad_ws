...
bool quad_interfaces__msg__aux_servos_calibration__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quad_interfaces.msg._aux_servos_calibration.AuxServosCalibration", full_classname_dest, 64) == 0);
  }
  quad_interfaces__msg__AuxServosCalibration * ros_message = _ros_message;
  {  // pin
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * quad_interfaces__msg__aux_servos_calibration__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of AuxServosCalibration */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quad_interfaces.msg._aux_servos_calibration");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AuxServosCalibration");
  ...
  quad_interfaces__msg__AuxServosCalibration * ros_message = (quad_interfaces__msg__AuxServosCalibration *)raw_ros_message;
  {  // pin
    PyObject * field = NULL;
