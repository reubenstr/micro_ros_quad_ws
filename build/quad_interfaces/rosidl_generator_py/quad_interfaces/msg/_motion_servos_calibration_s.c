...
bool quad_interfaces__msg__motion_servos_calibration__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quad_interfaces.msg._motion_servos_calibration.MotionServosCalibration", full_classname_dest, 70) == 0);
  }
  quad_interfaces__msg__MotionServosCalibration * ros_message = _ros_message;
  {  // pin
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * quad_interfaces__msg__motion_servos_calibration__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MotionServosCalibration */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quad_interfaces.msg._motion_servos_calibration");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotionServosCalibration");
  ...
  quad_interfaces__msg__MotionServosCalibration * ros_message = (quad_interfaces__msg__MotionServosCalibration *)raw_ros_message;
  {  // pin
    PyObject * field = NULL;
