...
{
  new (message_memory) quad_interfaces::msg::EmergencyStop(_init);
}

void EmergencyStop_fini_function(void * message_memory)
{
  auto typed_message = static_cast<quad_interfaces::msg::EmergencyStop *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EmergencyStop_message_member_array[1] = {
  {
    ...
    offsetof(quad_interfaces::msg::EmergencyStop, emergency_stop),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EmergencyStop_message_members = {
  ...
  1,  // number of fields
  sizeof(quad_interfaces::msg::EmergencyStop),
...
{
  return &::quad_interfaces::msg::rosidl_typesupport_introspection_cpp::EmergencyStop_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quad_interfaces, msg, EmergencyStop)() {
  return &::quad_interfaces::msg::rosidl_typesupport_introspection_cpp::EmergencyStop_message_type_support_handle;
}
