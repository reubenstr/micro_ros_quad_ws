...
bool rosidl_typesupport_microxrcedds_test_msg__msg__basic_primitive__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosidl_typesupport_microxrcedds_test_msg.msg._basic_primitive.BasicPrimitive", full_classname_dest, 76) == 0);
  }
  rosidl_typesupport_microxrcedds_test_msg__msg__BasicPrimitive * ros_message = _ros_message;
  {  // a
...
{
  /* NOTE(esteve): Call constructor of BasicPrimitive */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosidl_typesupport_microxrcedds_test_msg.msg._basic_primitive");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BasicPrimitive");
