...
void NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_init_function(
...
void NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_fini_function(void * message_memory)
{
  complex_msgs__msg__NestedMsgTest__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_message_member_array[14] = {
  {
    "data1",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_message_members = {
  "complex_msgs__msg",  // message namespace
  "NestedMsgTest",  // message name
  14,  // number of fields
  sizeof(complex_msgs__msg__NestedMsgTest),
  NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_message_member_array,  // message members
  NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_init_function,  // function to initialize message memory (memory has to be allocated)
  NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_message_type_support_handle = {
  0,
  &NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, complex_msgs, msg, NestedMsgTest)() {
  NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_message_member_array[13].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, complex_msgs, msg, MultiStringTest)();
  if (!NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_message_type_support_handle.typesupport_identifier) {
    NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &NestedMsgTest__rosidl_typesupport_introspection_c__NestedMsgTest_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
