...
static const _NotEnoughtMemoryTest_type_support_symbol_names_t _NotEnoughtMemoryTest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosidl_typesupport_microxrcedds_test_msg, msg, NotEnoughtMemoryTest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosidl_typesupport_microxrcedds_test_msg, msg, NotEnoughtMemoryTest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, rosidl_typesupport_microxrcedds_test_msg, msg, NotEnoughtMemoryTest)),
  }
};
...
{
  return &::rosidl_typesupport_microxrcedds_test_msg::msg::rosidl_typesupport_cpp::NotEnoughtMemoryTest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosidl_typesupport_microxrcedds_test_msg, msg, NotEnoughtMemoryTest)() {
  return get_message_type_support_handle<rosidl_typesupport_microxrcedds_test_msg::msg::NotEnoughtMemoryTest>();
}
