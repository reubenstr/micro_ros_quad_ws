...
bool quad_interfaces__msg__motion_servos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quad_interfaces.msg._motion_servos.MotionServos", full_classname_dest, 47) == 0);
  }
  quad_interfaces__msg__MotionServos * ros_message = _ros_message;
  {  // enable
...
{
  /* NOTE(esteve): Call constructor of MotionServos */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quad_interfaces.msg._motion_servos");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotionServos");
