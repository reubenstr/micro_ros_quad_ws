...
bool quad_interfaces__msg__aux_servos_parameters__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quad_interfaces.msg._aux_servos_parameters.AuxServosParameters", full_classname_dest, 62) == 0);
  }
  quad_interfaces__msg__AuxServosParameters * ros_message = _ros_message;
  {  // pin
...
{
  /* NOTE(esteve): Call constructor of AuxServosParameters */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quad_interfaces.msg._aux_servos_parameters");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AuxServosParameters");
