...
#include "quad_interfaces/msg/detail/aux_servos_parameters__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const quad_interfaces::msg::AuxServosParameters *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<quad_interfaces::msg::AuxServosParameters *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AuxServosParameters__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const quad_interfaces::msg::AuxServosParameters *>(
...
{
  return max_serialized_size_AuxServosParameters(full_bounded, 0);
}

static message_type_support_callbacks_t _AuxServosParameters__callbacks = {
  "quad_interfaces::msg",
  "AuxServosParameters",
...
static rosidl_message_type_support_t _AuxServosParameters__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AuxServosParameters__callbacks,
...
{
  return &quad_interfaces::msg::typesupport_fastrtps_cpp::_AuxServosParameters__handle;
}
