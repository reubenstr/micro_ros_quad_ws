...
static const _AuxServosParameters_type_support_symbol_names_t _AuxServosParameters_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quad_interfaces, msg, AuxServosParameters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quad_interfaces, msg, AuxServosParameters)),
  }
};
...
{
  return &::quad_interfaces::msg::rosidl_typesupport_cpp::AuxServosParameters_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quad_interfaces, msg, AuxServosParameters)() {
  return get_message_type_support_handle<quad_interfaces::msg::AuxServosParameters>();
}
